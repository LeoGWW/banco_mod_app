  ...
  return (
    <nav className="w-full flex py-6 justify-between items-center navbar">
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        ...
        alt="menu"
        className="w-[27px] h-[28px] object-contain"
        onClick={() => setToggle((prev) => !prev)}
        />
        <div
        className={`${toggle ? 'flex' : 'hidden'} p-6 bg-black-gradient position-absolute top-20 right-0 mx-4 my-2 min-w[140px] rounded-xl sidebar`}
        >
